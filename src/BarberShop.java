        ...
        public void run() {
            while (true) {
                try {
                    ...
                    System.out.println("El barbero está cortando el pelo, hay estas sillas disponibles " + sillas);
                    sentarse.release();
            ...
            while (true) {
                try {
                    ...
                    if (sillas > 0) {
                        ...
                        System.out.println("El cliente se sienta y hay estas sillas disponibles: " + sillas);
                        cliente.release(); // despierta al barbero
                        sentarse.release();
                        barbero.acquire(); // espera a que el barbero termine
                    } else {
                        System.out.println("El cliente se va y quedan estas sillas disponibles " + sillas);
